...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-gray-200 py-8 mt-16 border-t border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
        {/* Bloc gauche : Logo + nom */}
        <div className="flex items-center gap-2 mb-4 md:mb-0">
          <LogoHeader />
          <span className="ml-2 text-xl font-bold text-blue-400 tracking-wide">Conformed</span>
        </div>
        ...
        {/* Bloc droit : Copyright + réseaux sociaux + contacts */}
        <div className="flex flex-col items-center md:items-end gap-2">
          <div className="flex space-x-3 mb-1">
            {/* Icônes réseaux sociaux fictifs */}
            <a href="#" className="hover:text-blue-400 transition-colors duration-200" title="Twitter">
            ...
            <a href="#" className="hover:text-blue-400 transition-colors duration-200" title="Facebook">
            ...
            <a href="#" className="hover:text-blue-400 transition-colors duration-200" title="LinkedIn">
          ...
          {/* Contacts */}
          <div className="flex flex-col items-center md:items-end text-sm text-gray-300 gap-1">
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              <span>contact@conformed.com</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-400">© {new Date().getFullYear()} Conformed. Tous droits réservés.</span>
        </div>
      </div>
    </footer>
  );
