...
router.register(r'professions', views.ProfessionViewSet, basename='profession')
router.register(r'logements', views.LogementViewSet, basename='logement')
router.register(r'residences', views.ResidenceViewSet, basename='residence')
router.register(r'comportements', views.ComportementViewSet, basename='comportement')
router.register(r'utilisateurs', views.UtilisateurViewSet, basename='utilisateur')
router.register(r'dossiers-medicaux', views.DossierMedicalViewSet, basename='dossier-medical')
router.register(r'rapports', views.RapportViewSet, basename='rapport')
router.register(r'vaccins', views.VaccinViewSet, basename='vaccin')
router.register(r'infections', views.InfectionViewSet, basename='infection')
router.register(r'regles-conformite', views.RegleConformiteViewSet, basename='regle-conformite')
router.register(r'parametres-conformite', views.ParametreConformiteViewSet, basename='parametre-conformite')
...
router.register(r'resultats-analyse', views.ResultatAnalyseViewSet, basename='resultat-analyse')
router.register(r'alimentations', views.AlimentationViewSet, basename='alimentation')
router.register(r'acces', views.AccesViewSet, basename='acces')
router.register(r'demandes-exportation', views.DemandeExportationViewSet, basename='demande-exportation')

# Alertes de conformité
router.register(r'types-alertes-conformite', views_conformite.TypeAlerteConformiteViewSet, basename='type-alerte-conformite')
router.register(r'alertes-conformite', views_conformite.AlerteConformiteViewSet, basename='alerte-conformite')
router.register(r'regles-alertes-conformite', views_conformite.RegleAlerteConformiteViewSet, basename='regle-alerte-conformite')
...
router.register(r'audit-conformite', views_conformite.AuditConformiteViewSet, basename='audit-conformite')
